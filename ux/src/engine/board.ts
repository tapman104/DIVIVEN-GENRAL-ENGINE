import type { Board, GameState, Piece, PieceType, Square, Move } from './types';
...
export const CHAR_TO_PIECE_TYPE: Record<string, PieceType> = {
    p: 'p', n: 'n', b: 'b', r: 'r', q: 'q', k: 'k',
    P: 'p', N: 'n', B: 'b', R: 'r', Q: 'q', K: 'k'
};

export const PIECE_TYPE_TO_CHAR: Record<PieceType, string> = {
    p: 'p', n: 'n', b: 'b', r: 'r', q: 'q', k: 'k'
};
